...
| [core-spotlight-ask](skills/core-spotlight-ask/) | Index app content in Core Spotlight and build on-device Ask search — `CSSearchableItem` sync, reindex extensions, `CSUserQuery`, `SpotlightSearchTool`, search-then-summarize fallbacks, progressive results. |
